        ...
        return (
            <div>
                <div className="fs-1 fw-bold m-3 text-Capitalize"
                    style={{ marginTop: '3px !important', marginBottom: '0px !important' }}>
                    {this.props.coinName}
                </div>
                <section className="row m-3 mb-0" style={{ marginTop: ' 2px !important' }}>
                    <div className="card text-white text-center  m-3"
                        ...
                        <div className="card-body">
                            ...
                            <p className="card-text fw-bold fs-5" style={{ color: "#4db5ff" }}>
                                {this.props.mCap24} %
                            </p>
                        </div>
                    </div>
                ...
                <div>
                    <div className="text-white text-center"
                        style={{ overflow: 'visible', height: '2px', marginTop: "1%" }}> Current
                        Price</div>
                    <div style={{
                         fontSize: '90px',
                        fontWeight: '700', color: "#4db5ff", textDecoration: 'none solid rgb(255, 255, 255)',
                        textAlign: 'center'
                    }}>
